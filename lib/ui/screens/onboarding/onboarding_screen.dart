...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: spaces.sm),
                FilledButton(
                  onPressed: _busy || _familyName.text.trim().isEmpty
                      ? null
                      : _createFamily,
                  child: _busy
                      ? const SizedBox(
  ...
  Future<void> _createFamily() async {
    ...
    try {
      ...
      final id = await ref
          ...
          .createFamily(name: _familyName.text.trim(), ownerUid: uid);
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Could not create family: $e')));
    } finally {
  ...
  Future<void> _joinFamily() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Could not join family: $e')));
    } finally {
      if (mounted) setState(() => _busy = false);
    }
  }
